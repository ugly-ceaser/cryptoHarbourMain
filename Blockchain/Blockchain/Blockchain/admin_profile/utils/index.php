...
// $username = "arbikawn_Root";
// $password = "marti08139110216";
// $dbname = "arbikawn_Otika";
...
function getUsersentMessage ($conn, $userId) {
  ...
  echo $user_id;
   ...
   $message = "
           ...
           <h4> Thank you</h4>
                <small>Contact Us at support@fidelityprofit.org</small>
...
if(isset($_POST["DepositDeclined"])) {
  ...
  echo $user_id;
   ...
   $message = "
            ...
            <p>Please Contact Admin @ support@fidelityprofit.org for more Info </p>
