					...
					<div class="box-body">
						<div class="table-responsive">
							<table class="table table-bordered no-margin" style="min-width: 900px;">
								...
								<tbody>
									<?php if (count(pendingTransact($conn, "Deposits"))) : ?>
										<?php foreach (pendingTransact($conn,"Deposits") as $transact) : ?>
											<tr>
																						
											<?php  foreach (getUser($conn,$transact["registration_id"] ) as $row) {?>
												...
												<?php }?>
												<td>
													<?= date("D, m Y", strtotime($transact["date"])); ?>
												</td>
												<td>
												...
												<td>
													<div class="d-flex align-items-center">
														<?php if ($transact["status"] === "pending") : ?>
															<a href="../../handler/user_handler.php?approve=<?= $transact['id']; ?>&action=deposits" class="btn btn-sm btn-primary">
																Approve
															</a>
														<?php else : ?>
														...
														<a href="../../handler/user_handler.php?decline=<?= $transact['id']; ?>&action=deposits" class="btn btn-sm btn-danger ml-10">
															Decline
														</a>
													</div>
												</td>
					...
					<div class="box-body">
						<div class="table-responsive">
							<table class="table table-bordered no-margin" style="min-width: 900px;">
								...
								<tbody>
									<?php if (count(pendingTransact($conn, "Withdrawals"))) : ?>
										<?php foreach (pendingTransact($conn,"Withdrawals") as $transact) : ?>
											<tr>
											<?php  foreach (getUser($conn,$transact["registration_id"] ) as $row) {?>
												 ...
												 <?php }?>
												<td>
													<?= date("D, m Y", strtotime($transact["data"])); ?>
												</td>
												...
												<td>
													<div class="d-flex align-items-center">
														<?php if ($transact["status"] === "pending") : ?>
															<a href="../../handler/user_handler.php?approve=<?= $transact['id']; ?>&action=withdrawals" class="btn btn-sm btn-primary">
																Approve
															</a>
														<?php else : ?>
															<button disabled class="btn btn-sm">Approve</button>
														...
														<a href="../../handler/user_handler.php?decline=<?= $transact['id']; ?>&action=withdrawals" class="btn btn-sm btn-danger ml-10">
															Decline
														</a>
													</div>
												</td>
