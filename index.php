...
?>
    ...
    <section class="features" data-aos="fade-in">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-3 features-content" data-aos="fade-left" data-aos-delay="80">
                    <h4><span data-purecounter-start="0" data-purecounter-end="2011" data-purecounter-duration="4" class="purecounter"></span></h4>
                    <p>Founded</p>
                    <svg height="300" width="300">
    ...
    <!-- Another Section -->
    <section class="anotherSection py-5">
